...
const About = () => {
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/dharanidharansr",
      icon: (
    ...
    {
      name: "LeetCode",
      url: "https://leetcode.com/u/23ADR032/",
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
    ...
    {
      name: "Instagram",
      url: "https://www.instagram.com/_patrick_bateman.18",
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
    ...
    {
      name: "GitHub",
      url: "https://github.com/dharanidharansr",
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
    ...
    {
      name: "Devfolio",
      url: "https://devfolio.co/@srdharanidharan",
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
  ...
  Hi, I’m an engineering student specializing in Artificial Intelligence and Data Science. I have a strong passion for crafting innovative solutions by combining my love for web development and machine learning. As a MERN stack enthusiast, I enjoy exploring new technologies and figuring things out as I go, always eager to learn and grow in the world of full-stack development and AI.
        ...
        {/* GitHub Calendar */}
        <div className="pt-4">
          <GitHubCalendar username="dharanidharansr" />
        </div>
      </div>
    </section>
  );
